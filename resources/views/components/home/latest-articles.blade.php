    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6 mt-0">
        <div class="mb-12 space-y-2 text-center">
            ...
            <div class="group p-6 sm:p-8 rounded-3xl bg-white border border-gray-100 dark:shadow-none dark:border-gray-700 bg-opacity-50 shadow-2xl shadow-gray-600/10">
                ...
                <div class="mt-6 relative">
                    ...
                    <p class="mt-6 mb-8 text-gray-600 dark:text-gray-100">
                    ...
                    <a class="inline-block" href="/articles/avocat-suppleant">
                        <span class="text-info dark:text-blue-200">En savoir plus</span>
                    </a>
                </div>
