    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6 mt-0">
        <div class="mb-12 space-y-2 text-center">
            ...
            <div class="group p-6 sm:p-8 rounded-3xl bg-white border border-gray-100 dark:shadow-none dark:border-gray-700 shadow-2xl shadow-gray-600/10">
                ...
                <div class="mt-6 relative">
                    ...
                    <a class="inline-block" href="/articles/avocat-suppleant">
                        <span class="text-info dark:text-blue-500">En savoir plus</span>
                    </a>
                </div>
