...
{{--                                        </div>--}}
                        ...
                        <div class="mt-6 mb-6" x-show="audience">
                            ...
                            <select name="printType" id="ville" x-model="selectedCity" @change="calculateTotal"  class="block mt-1 w-full h-11 p-1 pl-3 bg-purple-100 rounded-md border-gray-300">
                                @php
                                    $ville="";
                        ...
                        <div class="grid sm:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-6 pt-3 pb-3 rounded-lg">
                        <!-- Option Urgence -->
                        <div class="mb-4">
    ...
    function priceCalculator() {
        return {
            ...
            calculateTotal() {
                ...
                const cityPrice = parseFloat(valeurs[1]);
                ...
                const abonnementPrice = this.isSubscribed ? 29 : 0;
                const plaidoiriePrice = parseFloat(this.selectedPlaidoirie.price);
                const urgencyPrice = this.isUrgent ? 250 : 0;

                const total = baseFee + cityPrice + pagePrice + reliurePrice + abonnementPrice + plaidoiriePrice + urgencyPrice;
