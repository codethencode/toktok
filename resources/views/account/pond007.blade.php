...
<script>
    ...
    $(document).ready(function() {
        ...
        const pond = FilePond.create(pondElement, {
            ...
            load: null,
            fetch: null,
            chunkUploads: true, // Activer l'upload par morceaux
            chunkForce: true, // Forcer l'utilisation des chunks
            chunkSize: 500000, // Taille des chunks, ici 500KB
        ...
        function refreshFileList() {
            $.ajax({
                url: '{{ route('files.index', '684-338-291') }}',
